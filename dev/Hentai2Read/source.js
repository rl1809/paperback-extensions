    ...
    async getHomePageSections(sectionCallback) {
        ...
        for (const section of sections) {
            ...
            promises.push(this.DOMHTML(url).then(async (response) => {
                section.items = await (0, Hentai2ReadParser_1.parseHomePageSectionMangas)(response);
                sectionCallback(section);
            }));
        }
...
},{"./Hentai2ReadHelper":71,"./Hentai2ReadParser":72,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
